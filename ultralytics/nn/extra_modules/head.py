...
class Detect_TADDH(nn.Module):
    ...
    def __init__(self, nc=80, hidc=256, ch=()):
        ...
        # self.conv = nn.ModuleList(nn.Sequential(nn.Conv2d(x, hidc, 3, padding=1)) for x in ch)
        self.localWindowAttention = LocalWindowAttention(hidc // 4)
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            # cls_prob = self.localWindowAttention(feat)
